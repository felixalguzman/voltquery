...
class _KnownHostsSectionState extends ConsumerState<KnownHostsSection> {
      ...
      children: [
        ...
        FutureBuilder<List<KnownHost>>(
          ...
          builder: (context, snap) {
            if (snap.hasError) {
              return Text(
                'Could not read known hosts: ${snap.error}',
  ...
  Widget _row(KnownHost h) => Container(
    ...
    child: Row(
      ...
      children: [
        ...
        Button(onPressed: () => _revoke(h), child: const Text('Revoke')),
      ],
    ),
  );
  ...
  Future<void> _revoke(KnownHost h) async {
    final ok = await confirm(
      ...
      message:
          'The next connection through this bastion will prompt you to '
